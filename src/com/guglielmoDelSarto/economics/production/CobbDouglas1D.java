...
/**
 * This class represent the famous production function:
 * <br>
...
public class CobbDouglas1D implements ProductionFunction {
	...
	public CobbDouglas1D(double alpha, double b) {
		if (alpha < 0.0 || alpha > 1.0) {
			throw new IllegalArgumentException("Parameter alpha has to be in [0, 1]");
		}
		this.c = alpha;
		this.b = b;
	}
	...
	public double getSecondDerivative(double investment) {
		return b*(c-1)*c*Math.pow(investment, c - 2.0);
	}
